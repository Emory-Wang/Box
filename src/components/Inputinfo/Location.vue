<template>
	<div style="width: 100%; height: 900px;">
				    ...
				    <div style="float: left;">
						...
						<el-form-item label="具体地址:" label-width="80px">
						  ...
						  <el-form-item label="扩散半径:" label-width="80px">
						      <el-input-number v-model="locdata[0].radius" @change="handleChange" :min="0" :max="100" label="描述文字"></el-input-number>
						    </el-form-item>
							<el-slider
				  ...
				  <el-collapse-item title="地点2" name="2" v-show="region>=2">
				    <div style="float: left;">
				  						...
				  						<el-form-item label="具体地址:" label-width="80px">
				  						  ...
				  						  <el-form-item label="扩散半径:" label-width="80px">
				  						      <el-input-number v-model="locdata[1].radius" @change="handleChange" :min="0" :max="100" label="描述文字"></el-input-number>
				  						    </el-form-item>
				  							<el-slider
				  ...
				  <el-collapse-item title="地点3" name="3" v-show="region>=3">
				    <div style="float: left;">
				  						...
				  						<el-form-item label="具体地址:" label-width="80px">
				  						  ...
				  						  <el-form-item label="扩散半径:" label-width="80px">
				  						      <el-input-number v-model="locdata[2].radius" @change="handleChange" :min="0" :max="100" label="描述文字"></el-input-number>
				  						    </el-form-item>
				  							<el-slider
				  ...
				  <el-collapse-item title="地点4" name="4" v-show="region>=4">
				    <div style="float: left;">
				  						...
				  						<el-form-item label="具体地址:" label-width="80px">
				  						  ...
				  						  <el-form-item label="扩散半径:" label-width="80px">
				  						      <el-input-number v-model="locdata[3].radius" @change="handleChange" :min="0" :max="100" label="描述文字"></el-input-number>
				  						    </el-form-item>
				  							<el-slider
				  ...
				  <el-collapse-item title="地点5" name="5" v-show="region>=5">
				    <div style="float: left;">
				  						...
				  						<el-form-item label="具体地址:" label-width="80px">
				  						  ...
				  						  <el-form-item label="扩散半径:" label-width="80px">
				  						      <el-input-number v-model="locdata[4].radius" @change="handleChange" :min="0" :max="100" label="描述文字"></el-input-number>
				  						    </el-form-item>
				  							<el-slider
		...
		<el-button type="primary" @click="next" style="float: right; margin-right: 40px;">下一步</el-button>
	</div>
