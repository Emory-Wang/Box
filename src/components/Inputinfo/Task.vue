<template>
	<div style="margin-top: 40px; width: 100%; height: 45px; border: 1px solid lightgray;">
		<el-row>
		...
		<div style="width: 100%; height: 100%; margin-top: 30px;margin-left: 20px;">
			<el-form :model="taskForm" :rules="rules" ref="taskForm" label-width="100px" class="demo-ruleForm">
				...
				<div style="text-align: center; margin-top: 120px; ">
							...
							<el-button type="primary" @click="submitForm('taskForm')" style="width: 130px;">下一步</el-button>
				</div>		
			</el-form>
		</div>
	</div>
